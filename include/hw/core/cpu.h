...
struct CPUState {
     ...
     * Hence, possible vCPU can have CPUState object in 'disabled' state
     * or can also not have CPUState object at all. This is possible
     * when vCPU Hotplug is supported and vCPUs are 'yet-to-be-plugged'
     * in the QOM or have been hot-unplugged.
     *
