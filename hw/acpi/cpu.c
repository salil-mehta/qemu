...
void acpi_cpu_plug_cb(const DeviceState *acpi_dev,
...
void acpi_cpu_unplug_request_cb(const DeviceState *acpi_dev,
                    ...
                    AmlRegionSpace rs)
{
    ...
    cpus_dev = aml_device("\\_SB.CPUS");
    {
        ...
        for (i = 0; i < arch_ids->len; i++) {
            ...
            /* build _MAT object */
            if (build_madt_cpu) {
                build_madt_cpu(i, arch_ids, madt_buf, true); /* set enabled */
